...
while True:
    ...
    print(n, ": x:", x, ": PIDOutput:", PIDOutput,"Error:",pidx.Error, "LastLastError:", LastLastError, "LastError", LastError, "SystemOutput:", SystemOutput,
          "LastSystemOutput:", LastSystemOutput)
    if x == 0:break
    # if n > 3:pidx(0)
...
# pidx = PID(kp, ki, kd, setpoint=0, sample_time=0, output_limits=(-320, 320))
#
# x = 300
# n = 0
# PIDOutput = 0
...
#     n += 1
#     x = int(x - PIDOutput)
#     PIDOutput = int(-pidx(x))
#     print(n, ": Input:", x, "PIDOutput:", PIDOutput)
#     if PIDOutput == 0:break
#     # if n > 3:pidx(0)
#     if n > 100:break
