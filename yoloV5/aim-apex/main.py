...
def run():
    ...
    ## 加载模型
    weights = r'E:\Pycharm\Python_Projects\yolov5\aim-apex\modles\apex-7000-n.engine'
        ...
        for i, det in enumerate(pred):
            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    """
                    tag  0 ct_head 1 ct_body 2 t_heda 3 t_body
                    """
                ...
                print("程序用时 ", time.time() - t0, "FPS:",int(1/(time.time() - t0)), "\n")
                    ...
                    # time.sleep(0.01)
        #         for i, det in enumerate(target_list):  # 可视化框
